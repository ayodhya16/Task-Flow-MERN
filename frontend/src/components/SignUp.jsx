...
import { Inputwrapper, BUTTONCLASSES, FIELDS, MESSAGE_ERROR, MESSAGE_SUCCESS } from '../assets/dummy';
        ...
        <div className='max-w-md w-full bg-white shadow-lg border-purple-100 rounded-xl p-8'>
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <button type='submit' className={BUTTONCLASSES} disabled={loading}>
                    {loading ? "Signing up..." : (<><UserPlus className='w-4 h-4 mr-2' />Sign Up</>)}
                </button>
            </form>
            <p className='text-center text-sm text-gray-600 mt-6'>
                ...
                <button
                    type='button'
                    onClick={() => typeof onSwitchMode === 'function' && onSwitchMode()}
